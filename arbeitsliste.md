# Arbeitsliste — deutsche Hochschulen & Universitäten (Sponsoring/Förderer-Recherche)

Legende Disposition:
- `[x] FERTIG` = bereits in Master-CSV (verifiziert in früherer Session)
- `[~] DISCOVERY` = in dieser Session per WebSearch vor-recherchiert (Kandidaten-URL + provisorische Einstufung; Link-/Email-Verifikation steht aus wegen Netzwerk-Blocker)
- `[ ] OFFEN` = noch nicht angefasst

Provisorische Einstufung (Degraded-Mode, nur WebSearch):
- `KANDIDAT (verify)` = Hauptdomain-Seite mit Sponsoring/Gegenleistung plausibel → Link- & Email-Verifikation nötig
- `SUBDOMAIN?` = Angebot scheint auf Subdomain → vmtl. AUSSCHLUSS, Hauptdomain-Pendant suchen
- `RAUS (Modell)` = dual/Praxispartner/Deutschlandstipendium-only/eigene Vereinsdomain → AUSGESCHLOSSEN
- `KEIN FUND` = keine passende Seite per WebSearch gefunden

---

## Bereits in Master-CSV (NICHT erneut prüfen)
LINK VERIFIZIERT: HdM Stuttgart · OTH Amberg-Weiden · TH Georg Agricola Bochum · THWS Würzburg-Schweinfurt
SPONSORING-SEITE: FH Wedel · HTWG Konstanz · H-BRS · HS Coburg · HS Osnabrück · Jade HS · KIT · RWTH Aachen · TH Aschaffenburg · TH Deggendorf · TU Chemnitz · Uni Bremen · Uni Marburg · Uni Passau · Uni Stuttgart
PRÜFEN/GRENZFALL: HS Ansbach · HNU Neu-Ulm · TU München · HS Esslingen · HS Reutlingen · Uni Halle · Uni Mainz · Uni Rostock
AUSGESCHLOSSEN: DHBW Karlsruhe · DHBW Mosbach · FH Aachen · FOM · Frankfurt UAS · FU Berlin · Goethe-Uni Frankfurt · HAW Hamburg · HWR Berlin · HS Darmstadt · HS Düsseldorf · HS Harz · HS Karlsruhe · HS Kempten · HS München · LMU München · Nordakademie · OTH Regensburg · TH Köln · TH Nürnberg · Uni Erfurt · Uni Hamburg · Uni Heidelberg · Uni Hildesheim · Uni Münster · Uni Tübingen · Uni Saarland · Uni zu Köln

---

## STARTREIHENFOLGE 1 — Große TUs/Unis
...
## STARTREIHENFOLGE 2 — HAW / TH (Ost + Nord + weitere)
